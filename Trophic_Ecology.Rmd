...
The first step is to identify the baseline values. Here we will use pico-nanoplanton and POM (sediment) as pelagic and littoral end-members respectively.
...
Congratulations!! You just ran your first stable isotope mixing model, easy huh!
...
Up to now we have looked at relatively simple two-endmembers mixing models. The previous 2 sources - 2 tracer model had several limitations:
